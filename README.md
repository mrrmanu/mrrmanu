...
🌱 I’m currently deepening my skills in Advanced Machine Learning, Feature Engineering, Model Optimization, and Python-based ML pipelines
...
💼 Data Science Intern @ Learnvista Pvt. Ltd.

📊 Experienced in building end-to-end ML pipelines: data preprocessing → EDA → feature engineering → model training → evaluation
...
Feature scaling, outlier handling, hyperparameter tuning
